...
const SignUp = (props) => {
    ...
    const handlesubmit = async (e) => {
        try {
            ...
            const response = await fetch("http://127.0.0.1:15000/auth/create", {
                method: "POST",
                headers: {
    ...
    return (
        <>
            <div className=" d-flex align-items-center flex-column">
                ...
                <p className="text-center my-3">Copyright &copy; 2024-2025 &mdash; Exam Portal - Already have an account <Link to='/login'>Login</Link></p>
            </div>
        </>
    )
}
